...
extern "C" jlong Java_libcore_icu_NativeConverter_getNativeFinalizer(JNIEnv*, jclass) {
    return reinterpret_cast<jlong>(&FreeNativeConverter);
}


extern "C" jlong Java_libcore_icu_NativeConverter_getNativeSize(JNIEnv*, jclass, jstring) {
