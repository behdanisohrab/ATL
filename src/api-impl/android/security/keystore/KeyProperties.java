...
public abstract class KeyProperties {
    ...
    public abstract static class EcCurve {
        ...
        public static int toKeymasterCurve(ECParameterSpec spec) {
            ...
            switch (keySize) {
                case 224:
                    return android.hardware.security.key_mint.EcCurve.P_224;
                case 256:
                    return android.hardware.security.key_mint.EcCurve.P_256;
                case 384:
                    return android.hardware.security.key_mint.EcCurve.P_384;
                case 521:
                    return android.hardware.security.key_mint.EcCurve.P_521;
                default:
                    return -1;
            }
        }
        ...
        public static int fromKeymasterCurve(int ecCurve) {
            switch (ecCurve) {
                case android.hardware.security.key_mint.EcCurve.P_224:
                    return 224;
                case android.hardware.security.key_mint.EcCurve.P_256:
                case android.hardware.security.key_mint.EcCurve.CURVE_25519:
                    return 256;
                case android.hardware.security.key_mint.EcCurve.P_384:
                    return 384;
                case android.hardware.security.key_mint.EcCurve.P_521:
                    return 521;
                default:
                    return -1;
            }
