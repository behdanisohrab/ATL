...
import android.hardware.security.Security;
import android.hardware.security.key_mint.Algorithm;
import android.hardware.security.key_mint.BlockMode;
import android.hardware.security.key_mint.Digest;
import android.hardware.security.key_mint.ErrorCode;
import android.hardware.security.key_mint.HardwareAuthenticatorType;
import android.hardware.security.key_mint.KeyFormat;
import android.hardware.security.key_mint.KeyOrigin;
import android.hardware.security.key_mint.KeyPurpose;
import android.hardware.security.key_mint.PaddingMode;
import android.hardware.security.key_mint.SecurityLevel;
import android.hardware.security.key_mint.Tag;
import android.hardware.security.key_mint.TagType;
...
public final class KeymasterDefs {
    ...
    public static final int KM_ERROR_key_mint_NOT_CONFIGURED =
            ErrorCode.key_mint_NOT_CONFIGURED; // -64
